...
declare interface IContract {
  ...
  only(description: string, callback: (accounts?: string[]) => any): any;
}
...
declare interface IDescribe {
  ...
  only(description: string, callback: () => any): any;
}
...
declare interface IIt {
  ...
  only(description: string, callback: TTest): any;
}
